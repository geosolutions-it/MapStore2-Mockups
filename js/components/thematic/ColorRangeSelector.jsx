...
const ColorUtils = require('../../../MapStore2/web/client/utils/ColorUtils');
    ...
    render() {
        ...
        return (
            <DropdownList
                ...
                value={head(items.filter( (i = {}) => i === this.props.value || i.name === (this.props.value && this.props.value.name)))}
                onChange={(ramp) => {
