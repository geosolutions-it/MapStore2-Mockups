...
const {FormGroup, FormControl, OverlayTrigger, Tooltip, Row, Col, Nav, NavItem, Button, ButtonGroup, Glyphicon} = require('react-bootstrap');
...
class StyleEditor extends React.Component {
        ...
        return (<div className="m-body-scroll-y">
            ...
            <div style={{/*width: '50%', marginLeft: '25%'*/}}>
                ...
                <div className="mapstore-block-width">
                    ...
                    <Col xs={6}>
                        <Combobox data={['solid', 'vertline', 'horline', 'slash', 'backslash', 'plus', 'times']} placeholder="Select texture"/>
                    </Col>
                    </Row>
                </div>
    ...
    render() {
        ...
        return (<span>
            {p.glyph !== 'font' ? <div style={{width: 500, height: 500, position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)'}}><PolygonThumb fill={p.fill} stroke={p.stroke}/></div>
        :
                                ...
                                <Button bsStyle="primary" className="square-button-md" onClick={() => {
                                    if (this.state.custom.code) {
                                        ...
                                        this.setState({
                                            ...
                                            enableCode: true,
                                            addPage: false,
                                            codeString: "* {\n\tstroke: " + this.state.custom.stroke + ";\n\tfill: " + this.state.custom.fill + ";\n\tstroke-width: 2px;\n}"
                                        });
                                    }
